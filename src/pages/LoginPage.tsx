  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#0A0A0A] text-white p-4">
      <div className="max-w-md w-full text-center">
        <h1 className="text-5xl font-bold text-[#6366F1] mb-2">Agenda</h1>
        ...
        <button
          onClick={handleLogin}
          className="flex items-center justify-center w-full max-w-[280px] h-12 mx-auto gap-3 bg-[#6366F1] hover:bg-[#4F46E5] text-white font-semibold py-3 px-6 rounded-lg transition-colors"
        >
